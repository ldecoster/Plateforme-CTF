...
def export():
    ...
    header_list = cur.fetchall()
    with open('vote.csv', 'w', newline='') as csv_file:
        c = csv.writer(csv_file, delimiter=',')
        c.writerow(header_list)
        for x in result:
            c.writerow(x)
    ...
    header_list = cur.fetchall()
    with open('challenge.csv', 'w', newline='') as csv_file:
        c = csv.writer(csv_file, delimiter=',')
        c.writerow(header_list)
        for x in result:
            c.writerow(x)
    ...
    header_list = cur.fetchall()
    with open('solve.csv', 'w', newline='') as csv_file:
        c = csv.writer(csv_file, delimiter=',')
        c.writerow(header_list)
        for x in result:
            c.writerow(x)
    ...
    header_list = cur.fetchall()
    with open('tag.csv', 'w', newline='') as csv_file:
        c = csv.writer(csv_file, delimiter=',')
        c.writerow(header_list)
        for x in result:
            c.writerow(x)
